...
if(!message.member.roles.cache.has(ayarlar.JailYetkilisi) && !message.member.hasPermission('ADMINISTRATOR')) return message.channel.send('Bu Komutu Kullanmak İçin Yetkiniz Bulunmamakta.')
  ...
  if(kişi.roles.highest.position >= message.member.roles.highest.position) return message.channel.send('Etiketlenen Kullanıcı Sizden Üst/Aynı Pozisyonda.')
    ...
    let zaman1 = args[1] 
          .replace("sn", "s")  //JAİL ATARKEN BURADAKİ ARGÜMANLARA GÖRE JAİL ATIN!
          .replace("dk", "m")
          .replace("sa", "h")
          .replace("gün", "d"); //CodeArius - alien.xxl
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◆◆◆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\\ 
 var vakit = zaman1
            .replace("m", " dakika") //CodeArius - alien.xxl
            .replace("s", " saniye")
            .replace("h", " saat")
            .replace("d", " d"); //CodeArius - alien.xxl
        
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◆◆◆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\\

  db.set(`cezali_${message.guild.id + kişi.id}`, 'cezali') //CodeArius - alien.xxl
  ...
  let jailsorgu = db.fetch(`jailSorgu.${kişi.id}`);   //CodeArius - alien.xxl
  
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◆JAİL◆BAŞLANGIÇ◆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\\  
  
  let zaman = args[1]
  if(!args[1]) return message.channel.send(':white_small_square::grey_question: Kadar Süre Duracağını Belirt.')

let sebep = args.join(``).slice(args[1].length+args[0].length)
if(!sebep) return message.channel.send(':white_small_square::grey_question: Bir Sebep Belirt.')
  
  const jail = new Discord.MessageEmbed()
  .setColor(`GREEN`)
  .setAuthor(message.author.username, message.author.avatarURL({ dynamic : true }))
  .setDescription(`<@${kişi.id}> (\`${kişi.id}\`) üyesi sunucuda <@&JAİL ROL İD> rolü verilerek cezalandırıldı.  //JAİL ROL İD DOLDURMAYI UNUTMA !
...
• Sebep: \`${sebep}\``)   //CodeArius - alien.xxl
  
 
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◆JAİL◆MESAJ◆AYARLAMALARI◆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\\  
